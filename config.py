...
# Piper CLI synthesis matches the verified Raspberry Pi audio output. Set
# PIPER_MODE="api" to retain the in-process Python API implementation.
PIPER_MODE = "cli"
PIPER_MODEL_PATH = (
...
PIPER_PYTHON_PATH = "/home/pi/vision-env/bin/python"
